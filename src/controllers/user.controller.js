...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(new apiResponse("Succesfully done", 200, {}));
});
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse("Updated account details ", 200, user));
});
...
const getWatchHistory = asyncHandler(async (req, res) => {
    ...
    },
    {
      $lookup: {
        ...
        pipeline: [
          {
            $lookup: {
              // now we are inside the video and here we are implementing the lookup pipeline
              from: "users",
              localField: "owner",
              foreignField: "_id",
              as: "owner",
  ...
  return res
    ...
    .json(
      new apiResponse(
        "Fethced user watch history successfully",
        200,
        user[0].watchHistory
      )
    );
